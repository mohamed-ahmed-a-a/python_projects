...
print("\n\tThis is a User Application for : ")
print("\n\tSaving User Information for User Mobile Application\n\n")
...
# I Can do a lot of operations on user such as (add - update - remove - remove - delete - display ) a User
...
print("\t\n- Press \'n\' or \'N\' or \'End\' or \'Exit\' To Exit")
print("\t\n-------------------------------------------------------")
